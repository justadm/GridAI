...
Локально открыть:
```bash
open /Users/just/projects/GridAI/web/index.html
```

Админ‑страница:
```bash
open /Users/just/projects/GridAI/web/admin.html
```

ЛК (портал):
```bash
open /Users/just/projects/GridAI/web/portal/dashboard.html
```

UI‑kit:
```bash
open /Users/just/projects/GridAI/web/ui-kit.html
```

Логин:
```bash
open /Users/just/projects/GridAI/web/login.html
```
...
- `GET /oauth/:provider/callback` → публичный callback OAuth на `auth.gridai.ru`
...
Код SSR фронта:
- `/Users/just/projects/GridAI/apps/web-ssr`
